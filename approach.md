...
5. Continue in that hold-probe-hold-probe pattern until either the timer stops or a failed probe closes the block per step 4. You are not trying to advance every session; you are collecting data.
