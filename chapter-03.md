...
| --- | --- | --- | --- | --- |
| 1 | Warm-Ups | Three-note grouping, RLR / LRL footings | 50 bpm | 110 bpm |
| 2 | Warm-Ups | Three-note grouping, footing variant | 50 bpm | 110 bpm |
| 7 | Beats | First beat with three consecutive 16ths | 50 bpm | 110 bpm |
| 9 | Beats | Three consecutive 16ths in a different placement | 50 bpm | 110 bpm |
...
| Ex. | Section | Role | Start | Target |
| --- | --- | --- | --- | --- |
| 3 | Warm-Ups | Alternate footing (RLL / LRR) | 50 bpm | 110 bpm |
| 4 | Warm-Ups | Alternate footing (LRR / RLL) | 50 bpm | 110 bpm |
| 14 | Beats | Beat variant | 50 bpm | 110 bpm |
| 19 | Fills | One-measure fill | 50 bpm | 110 bpm |
| 22 | Fills | One-measure fill | 50 bpm | 110 bpm |
...
- The footing labels under each Warm-Up (RLR, LRL, RLL, LRR, RRR-LLL, and so on) are the whole point of the section. Do not smear them into one footing you find comfortable.
- Rotate the footing variant across sessions rather than trying to hold every variant in one session.
- Three-note groupings often sit on the "and" of a beat. If placement is drifting, drop the bpm and count the subdivision aloud.
- Do not raise bpm until both the RLR and LRL variants of the same exercise hold a clean pass.
