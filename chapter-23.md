...
- **Section labels present:** none — the chapter is a single-concept study, in the same shape as Ch. 22
...
Final chapter of Stage 6 (`approach.md` §5), and — like Ch. 22 — a single-concept study rather than a drill library. R&L's premise: doubles in the hands sit above singles in the feet. Most players roll doubles more evenly and for longer than singles, and the feet make good followers — once the hands lay down a stable rhythm the feet can trace it.
...
The bpm defaults come from the 16th-note beats row of `approach.md` §4 (start 50 bpm, target ~110 bpm). Because the hands are playing doubles at 16th-note rates over singles in the feet, real starting bpm will often be lower — drop until the doubles in the hands stay even.
...
Log this chapter's work with the exercise number prefixed by `23.` — for example `23.2  60 bpm  pass  even-doubles`. See `approach.md` §7.
