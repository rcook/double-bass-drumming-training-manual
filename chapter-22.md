...
- **Ex. 22.1**—a quads reference pattern for comparison.
- **Ex. 22.2**—the ladder itself, at a base rate. This is where most of the work happens.
- **Ex. 22.3**—the ladder in a triplet feel. R&L recommends thinking in triplets as the way in—that framing came originally from Gregg Bissonette via Bill Miller.
- **Ex. 22.4**—16ths with the hands staying constant and the feet moving in and out.
- **Ex. 22.5**—the same shape as Ex. 22.4 but in triplets.
- **Ex. 22.6**—inverted ladder: feet stay constant, hands drop in and out.
- **Ex. 22.7**—the inverted-ladder idea in 16ths.
- **Ex. 22.8**—a triplet groove that moves into a ladder fill.
...
| --- | --- | --- | --- |
| 22.2 | Ladder base pattern | 40 bpm | 100 bpm |
| 22.3 | Ladder in triplet feel (the felt entry point) | 40 bpm | 100 bpm |
| 22.4 | Hands constant, feet drop in and out (16ths) | 50 bpm | 110 bpm |
| 22.5 | Hands constant, feet drop in and out (triplets) | 40 bpm | 110 bpm |
| 22.6 | Inverted ladder—feet constant, hands drop in | 50 bpm | 110 bpm |
| 22.7 | Inverted ladder in 16ths | 50 bpm | 110 bpm |
| 22.8 | Triplet groove into ladder fill | 40 bpm | 100 bpm |

Ex. 22.1 is a quads reference and does not need its own working bpm—play it once to feel the contrast with Ex. 22.2.

## Practice notes

- Ex. 22.3 is the felt entry point. R&L's whole point about "thinking in triplets" is that the ladder motion clicks in triplet feel before it clicks in 16ths. Do not increase speed until the motion is honest.
- Do not flam the ladder. R&L flags this specifically for Ex. 22.7 but it applies throughout—the hands and feet must land distinctly between each other.
