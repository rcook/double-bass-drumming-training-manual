...
The bpm defaults come from the 16th-note beats row of [approach.md §4](approach.md#4-the-tempo-target-and-clean-pass-rule) (start 50 bpm, target ~110 bpm). The feet are on 8ths or triplet 8ths here, so the ceiling is higher than in Chs. 2–7—but the hand placement is the hard part, not the feet.
...
Log this chapter's work with the exercise number prefixed by `11.`—for example `11.1  76 bpm  5 min  pass  hand-placement`. See [approach.md §8](approach.md#8-tracking).
