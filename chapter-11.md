...
- **Book pages:** R&L pp. 52–53
- **Total exercises:** ~12, all under a single "Beats" section
...
Application chapter (Stage 5 in [Approach §5](approach.md#5-the-chapter-progression)). R&L introduces power threes as a quick and effective way to develop a thick-sounding beat. The structural idea is simple: the feet stay constant on a straight-8th or shuffle pattern, and the weak hand—on snare or a tom—plays *between* the strokes of the feet.
...
The bpm defaults come from the 16th-note beats row of [Approach §4](approach.md#4-the-tempo-target-and-clean-pass-rule) (start 50 bpm, target ~110 bpm). The feet are on 8ths or triplet 8ths here, so the ceiling is higher than in Chs. 2–7—but the hand placement is the hard part, not the feet.

## Core (most sessions)

| Ex. | Section | Role | Start | Target |
| --- | --- | --- | --- | --- |
| 1 | Beats | Continuous 8ths feet, hand between the feet (straight-8th feel) | 50 bpm | 110 bpm |
| 3 | Beats | Straight-8th power-three variant | 50 bpm | 110 bpm |
| 6 | Beats | Triplet / shuffle feel, hand between the feet | 50 bpm | 110 bpm |

## Rotation (some sessions)

| Ex. | Section | Role | Start | Target |
| --- | --- | --- | --- | --- |
| 5 | Beats | Straight-8th variant with alternate hand placement | 50 bpm | 110 bpm |
| 8 | Beats | Shuffle-feel variant | 50 bpm | 110 bpm |
| 11 | Beats | 16th-note feet under a power-three hand pattern | 40 bpm | 100 bpm |

## Reference (discretionary)

Beats 2, 4, 7, 9, 10, 12 are variants on the same idea. Sample them for variety. The 16th-note-feet extension is the hardest content in the chapter and is only worth touching once the straight-8th and shuffle versions are clean.
...
Log this chapter's work with the exercise number prefixed by `11.`—for example `11.1  76 bpm  5 min  pass  hand-placement`. See [Approach §8](approach.md#8-tracking).
